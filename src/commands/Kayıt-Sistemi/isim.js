...
run: async (client, message, args, prefix) => { 
    ...
    {
    message.react(red)
    message.reply({ content:`\`isim <@Wasley/ID> <Isim> <Yaş>\``}).then((e) => setTimeout(() => { e.delete(); }, 5000)); 
    return }
...
.setDescription(`
${message.author} Başarıyla ${uye.toString()} Üyesinin İsmi "${setName}" Olarak Değiştirildi
