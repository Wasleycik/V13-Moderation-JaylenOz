...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    if (!message.member.permissions.has("ADMINISTRATOR") && !conf.staffs.some(x => message.member.roles.cache.has(x))) return message.channel.send("Bu Komutu Kullanabilmek İçin Gereken Yetkin Yok")
