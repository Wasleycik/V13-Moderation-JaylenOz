...
module.exports = async (message) => {
  ...
  const embed = new MessageEmbed().setFooter(conf.botfooter).setColor(message.member.displayHexColor).setAuthor({ name: message.member.displayName, iconURL: message.author.avatarURL({ dynamic: true })});
  ...
  let komutLog = client.channels.cache.find(x => x.name.includes(conf.komutlog));
