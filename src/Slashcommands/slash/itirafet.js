...
module.exports = {
 ...
 let itiriafkanalı = await client.channels.cache.find(x => x.name.includes(conf.itirafkanal))
 let itiraflogu = await client.channels.cache.find(x => x.name.includes(conf.itiraflog))
